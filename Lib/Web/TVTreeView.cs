...
namespace TruongViet.Lib.Web
{
    ...
    {
       // private DataView mdtvDuLieu;
       // private string mTenTruongCha;
       // private string mTenTruongKhoa;
       // private string mTenTruongText;
       ...
       // public void TaoNodes(TreeNode nodeGoc, int ID_Cha)
       // {
       ...
       // /// <returns></returns>
       // public TreeNode TaoNode(int mKhoa, string mText)
       // {
       ...
       // public string DuyetTreeView(TreeNode treeNode, string sTruongKhoa)
       // {
       //     string sID= "";
       ...
       // private void LayNodeDonVi(TreeNode treeNode, ref string sID)
       // {
       ...
       // /// <param name="treeNode"></param>
       // /// <returns></returns> 
       // public TreeNode LayGocCay(TreeView treeView)
       // {
       //     //try
       //     //{
