...
{ 
    ...
    private cBNhatKyHeThong oBNhatKyHeThong = new cBNhatKyHeThong();
	...
	protected void LoadCss() 
	{
        ...
        Label lbl = new Label();
        lbl.Text = "<link href='" + Request.ApplicationPath + "Resources/Css/TVLib.css'" + " type='text/css' rel='StyleSheet'>";
        this.Controls.Add(lbl); 
	}
    public void CallJS(string TenKhoiJS, string JS)
    {
        RegisterStartupScript(TenKhoiJS, "<Script language='JavaScript'>" + JS + "</Script>");
    }
    // Load JS
    ...
    // Write Log method
    public void WriteLog(int intChucNangID, string strMsg, string strIPMayTram, string strUserName)
    {
        oNhatKyHeThongInfo.CongViec = strMsg;
        oNhatKyHeThongInfo.IPMay = strIPMayTram;
        oNhatKyHeThongInfo.TenDangNhap = strUserName;
        oNhatKyHeThongInfo.IDChucNang = intChucNangID;
        oBNhatKyHeThong.Add(oNhatKyHeThongInfo);
    }
            ...
            if (ctl.ID != "")
            {
                ...
                switch (ctl.GetType().ToString())
                {
                    case "System.Web.UI.WebControls.GridView":
                        ...
                        {
                            ((GridView)(ctl)).CssClass = "TVLibFullGrid";
    ...
    /// </summary>
    public DateTime ChuyenVietSangAnh(string sDate)
    {
        if (sDate == "")
        ...
        try
        {
            dtOut = new DateTime(Convert.ToInt32(arrDate[2]), Convert.ToInt32(arrDate[1]), Convert.ToInt32(arrDate[0]));
            return dtOut;
        }
        catch
        {
    ...
    /// </summary>
    public string ChuyenAnhSangViet(string sDate)
    {
        if (sDate == "")
            return "";
