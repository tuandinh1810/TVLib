<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LuuThongIndex.aspx.cs" Inherits="LuuThong_LuuThongIndex" MasterPageFile="~/MasterPage.master"  %>
...
<body>
    ...
    <td>
        ...
        <asp:HyperLink ID="HyperLink4" runat="server" 
            NavigateUrl="~/LuuThong/BaoCao-ThongKe/ThongKeIndex.aspx">Báo cáo thống kê</asp:HyperLink>
        </td>     
    </tr>
      <tr  style="background-color: #f0f3f4;">
    <td width ="10%" align="right" >
