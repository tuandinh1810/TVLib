<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TK_MuonNhieuNhat.aspx.vb" Inherits="BoSungBienMuc_ThongKe_NgayBienMuc" MasterPageFile="~/MasterPage.master" %>
                 ...
                 <tr class ="TVLibPageTitle">
                    <td  colspan ="4">
                        <asp:Label ID="Label1" runat="server"  Width ="100%" 
                            Text="Thống kê những tài liệu được mượn nhiều nhất"></asp:Label>
