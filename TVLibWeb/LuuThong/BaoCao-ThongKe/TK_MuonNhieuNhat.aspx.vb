...
Partial Class BoSungBienMuc_ThongKe_NgayBienMuc
    ...
    Private Sub DrawTop20Stat()
        ...
        dtbThongKe = objTaiLieu.GetTop20_MuonNhieuNhat(TVDateTime.ChuyenVietSangAnh(txtFromDate.Text.Trim()), TVDateTime.ChuyenVietSangAnh(txtToDate.Text.Trim()))
    ...
    Protected Sub btnThongKe_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnThongKe.Click
        If txtFromDate.Text <> "" And txtFromDate.Text <> "" Then
            DrawTop20Stat()
