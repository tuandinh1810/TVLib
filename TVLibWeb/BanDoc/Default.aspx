<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="BanDocDefault" MasterPageFile="~/MasterPage.master"  %>
...
<body>
    ...
    <td>
        ...
        <asp:HyperLink ID="HyperLink4" runat="server" 
            NavigateUrl="~/BanDoc/BaoCaoThongKe/ThongKeIndex.aspx">Báo cáo thống kê</asp:HyperLink>
    </td>    
    </tr>
     <tr  style="background-color: #f0f3f4;">
    <td width ="10%" align="right" >
    ...
    <td>
      ...
      <tr  style="background-color: #f0f3f4;">
    <td width ="10%" align="right" >
        &nbsp;<asp:ImageButton ID="ImageButton1" ImageUrl="~/Resources/Images/HoSoBanDoc.png" 
            runat="server" 
            /></td>
    <td width="30%">
        &nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink1" runat="server" 
            NavigateUrl="~/BanDoc/KhoaThe.aspx">Khóa thẻ bạn đọc</asp:HyperLink>
        </td>   
      <td width ="10%" align="right"  >
          &nbsp;</td>
    <td>
