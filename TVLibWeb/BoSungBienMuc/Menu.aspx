<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Menu.aspx.cs" Inherits="BoSungBienMuc_Menu" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        {   
            ...
            if (oldSubMenuCtl=="")
            {
                document.getElementById("lnkBienMuc").className = "SubMenu";
            }
        ...
        <table style="background-image:url(../Resources/Images/DLib_Menu_Pen.gif);" cellspacing="0" cellpadding="0" border="0" style="height:86px">
         <tr align="left"  style="height:40px; margin-top:5px" >
            <td style="Width: 6%;margin-left: 0px" align=left rowspan=2>
                <a href="javascript:top.document.location.href='../Default.aspx'"><img border=0 src="../Resources/Images/TVLib_LogoPen.gif"  /></a>
            </td>            
            <td style="Width: 20%; Text-Align:Center">
                <a  id="lnkBoSungBienMuc" class="ActiveMenu" href="javascript:GotoMenu('lnkBoSungBienMuc','../BoSungBienMuc/Default.aspx');void(0);">Bổ sung Biên mục</a>
            </td>
                ...
                <table  style="width:100%">
                    <tr  style="width:100%">                                        
                        ...
                        <td align="center" style="width:15%" >
                            <a ID="lnkBienMuc"  class="ActiveSubMenu" href="javascript:GotoSubMenu('lnkBienMuc','DanhSachTaiLieu.aspx');void(0);">Biên mục</a>
                        </td>
                        
                        <td align="center" style="width:15%">
                            <a ID="lnkQLKho" class="SubMenu" href="javascript:GotoSubMenu('lnkQLKho','QuanLyKhoIndex.aspx');void(0);">Quản lý kho</a>
                        </td>
                        <td align="center" style="width:15%">
                            <a ID="lnkInAn" class="SubMenu" href="javascript:GotoSubMenu('lnkInAn','InAn/InAnIndex.aspx');void(0);">In ấn</a>
                        </td>
                          <td align="center" style="width:15%">
                            <a ID="lnkKiemKe" class="SubMenu" href="javascript:GotoSubMenu('lnkKiemKe','KiemKe/MainIndex.aspx');void(0);">Kiểm kê</a>
                        </td>
                        <td align="center" style="width:20%">
                            <a ID="lnkBaoCaoThongKe" class="SubMenu" href="javascript:GotoSubMenu('lnkBaoCaoThongKe','BaoCao-ThongKe/MainIndex.aspx');void(0);">Báo cáo - Thống kê</a>
                        </td>
                        <td align="center" style="width:15%">
                            <a ID="lnkDanhMuc" class="SubMenu" href="javascript:GotoSubMenu('lnkDanhMuc','DanhMuc/DanhMucIndex.aspx');void(0);">Danh mục</a>
                        </td>                        
