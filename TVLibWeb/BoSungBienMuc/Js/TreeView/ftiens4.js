...
{ 
  ...
  {
	this.iconSrc = ICONPATH + "he_thong_luu_tru.gif";
	this.iconSrcClosed = ICONPATH + "he_thong_luu_tru.gif";
  }
...
{ 
  ...
  { 
	if (USEFRAMES)
	  docW = docW + "<a href='" + this.hreference + "' TARGET=\"" + this.targetFrame + "\" "
	else
...
function gFldSystemRoot(description, hreference) 
{ 
  folder = new Folder(description, hreference, 0);
  return folder;
}
