<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Barcodes.aspx.cs" Inherits="BoSungBienMuc_InAn_Barcodes" MasterPageFile="~/MasterPage.master" %>
			...
			<table id="AcqBarCode" cellSpacing="1" cellPadding="2" width="970px" align="center"  >
				...
				<td>
				    <asp:textbox id="txtMaTaiLieu" Runat="server"  ></asp:textbox>&nbsp;
				     <asp:HyperLink NavigateUrl="#" ID="lnkTimTaiLieu" Runat="server" Text="Tìm" ></asp:HyperLink>
				     </td>
				</tr>
