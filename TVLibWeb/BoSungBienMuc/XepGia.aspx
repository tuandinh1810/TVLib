<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XepGia.aspx.cs" Inherits="XepGia" MasterPageFile="~/MasterPage.master" %>
        ...
        <td align="center">
            ...
            <tr>
                <td height="17" align="left" colspan="6" >
                    ...
                    <asp:Label ID="lblTenTaiLieu"  ForeColor="#0066FF" Font-Size="Large" runat="server" >Nhan đề</asp:Label>
                </td>
            </tr>
            <tr>
            <td colspan="6">&nbsp;</td>
...
&nbsp;<asp:Button ID="btnInNhanGay" runat="server" Text="In Nhãn Gáy" />
            ...
            <tr>
                <td height="17" align="left" colspan="4"  width="50%">
                ...
                <asp:Button ID="btnLuuBanGoc" runat="server" Text="Lưu Bản Gốc" 
                     />
                </td>
                <td align="right" colspan="3">
                    <asp:Label runat="server" ID="lblTotalMaXG"  Font-Bold="True" 
