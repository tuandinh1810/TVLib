<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ThongKe_DangTaiLieu.aspx.vb" Inherits="BoSungBienMuc_ThongKe_DangTaiLieu" MasterPageFile="~/MasterPage.master" %>
                 ...
                 <tr class ="TVLibPageTitle">
                    <td  colspan ="4">
                        <asp:Label ID="Label1" runat="server"  Width ="100%" 
                            Text="Thống kê theo dạng tài liệu"></asp:Label>
