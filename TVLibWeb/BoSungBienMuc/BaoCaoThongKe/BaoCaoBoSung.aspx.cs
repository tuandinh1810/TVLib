    ...
    protected void btnIn_Click(object sender, EventArgs e)
    {
        if (grvTaiLieu.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < grvTaiLieu.Rows.Count; i++)
            {
                ...
                mstr = mstr + "<Td  ><Font face='Times New Roman' style='Font-Size:12pt'>" + grvTaiLieu.Rows[i].Cells[0].Text.ToString() + "</Font></Td>";
            ...
            mstr = "<html><head><meta http-equiv=\"content-type\" content=\"text/html; charset=utf-8\"></head><body><Font face='Times New Roman' style='font-size:14' Color='#0066CC' ><span align='center'><B>BÁO CÁO HOẠT ĐỘNG BỔ SUNG</B></span></Font><br /><br /><table border='1' cellspacing=0 cellpadding=0 width=100%>" + mstr + "</table></Body></HTML>";
