...
Partial Class BoSungBienMuc_ThongKe_DangTaiLieu
    ...
    Protected Sub btnXuatExcel_Click(sender As Object, e As EventArgs) Handles btnXuatExcel.Click
        ...
        dtbThongKe = objTaiLieu.GetSoLuong_ByLoaiTaiLieu(CInt(drdlThang.SelectedValue.ToString()), CInt(drdlNam.SelectedValue.ToString()))


        ' *****************  Chuẩn bị tệp excel mẫu để ghi dữ liệu*******************
        Dim exBook As New Workbook()
        exBook.Open(Server.MapPath("~/Template/BaoCaoDangTaiLieu.xls"), FileFormatType.Excel2003)
        ...
        For i As Integer = 0 To dtbThongKe.Rows.Count - 1
            ...
            _range(DongHienTai, 1).PutValue(dtbThongKe.Rows(i)("MoTa").ToString())
        ...
        exBook.Save("BaoCaoDangTaiLieu" & DateTime.Now.ToString("dd_MM_yyyy") & ".xls", FileFormatType.Excel2003, SaveType.OpenInExcel, System.Web.HttpContext.Current.Response)
    End Sub
End Class