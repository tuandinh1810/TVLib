<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ThongKe_BoSung.aspx.vb" Inherits="BoSungBienMuc_ThongKe_BoSung" MasterPageFile="~/MasterPage.master" %>
                 ...
                 <tr class ="TVLibPageTitle">
                    <td  colspan ="4">
                        <asp:Label ID="Label1" runat="server"  Width ="100%" 
                            Text="Thống kê hoạt động bổ sung"></asp:Label>
